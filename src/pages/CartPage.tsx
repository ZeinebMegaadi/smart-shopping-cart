...
import { ShoppingBag, ShoppingCart, ListCheck, Receipt } from "lucide-react";
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className={`transition-all duration-500 transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
        <h1 className="text-3xl font-bold mb-8 gradient-text">Your Smart Shopping Checklist</h1>
